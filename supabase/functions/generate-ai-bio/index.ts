...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // 1. Verificar usuario con API REST de Auth (Zero Dependencies)
    ...
    // 2. Obtener perfil con API REST de Base de Datos
    ...
    // Retornamos status 200 para que el frontend pueda leer el error en data.error
