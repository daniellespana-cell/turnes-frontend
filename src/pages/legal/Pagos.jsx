...
const cardTextColor = 'zinc-200';      // Texto claro (Zinc para armonía con negro)
            ...
            <div className="flex-grow pt-8 pb-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className={`text-xl text-${mutedText} max-w-3xl mx-auto leading-relaxed`}>
                    ...
                    >
                        ...
                        <PolicyContent id="p2" title="2. Tarifa de Conexión (Comisión del Servicio)">
                            ...
                            <div className="mt-4 p-4 bg-zinc-900/10 rounded-lg border border-zinc-800/20">
                        ...
                        <PolicyContent id="p5" title="5. Política de No Reembolso (Bienes Digitales)">
                            <div className="p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
                                <p className="font-bold text-red-400 mb-2">IMPORTANTE: Recargas y Suscripciones</p>
                                <ul className="list-disc list-inside ml-2 space-y-2 text-gray-300">
                                    <li><span className="font-semibold text-white">Recargas de Saldo:</span> Las recargas de billetera se consideran <span className="text-white">bienes digitales consumibles</span> de entrega inmediata. Por tanto, <strong>NO tienen reembolso</strong> una vez acreditadas en la plataforma.</li>
                                    <li><span className="font-semibold text-white">Derecho de Retracto:</span> Al realizar una recarga, el usuario renuncia expresamente al derecho de retracto, dada la naturaleza digital y el consumo inmediato del servicio de conexión.</li>
                                    <li><span className="font-semibold text-white">Excepciones:</span> Solo se evaluarán reembolsos en casos de <span className="text-white">falla técnica comprobada</span> donde el saldo no haya sido acreditado ni utilizado.</li>
                                </ul>
                            </div>
                        </PolicyContent>
