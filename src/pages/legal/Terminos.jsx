    ...
    return (
        ...
        <div className="min-h-screen flex flex-col bg-black text-white font-sans">
            <SEO 
                ...
                description="Conoce los términos legales de uso de la plataforma Turnes para trabajadores y empresas."
            />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="pb-4 mb-8 border-b border-zinc-800/30">
                            ...
                            <p className={`text-sm text-${mutedText} mt-1`}>Fecha de última actualización: 1 de octubre de 2025</p>
                        </div>
                        ...
                        <TermsContent id="s3" title="3. Prestación de Servicios Independientes (Cláusula Clave)">
                            ...
                            <div className="mt-4 p-4 bg-indigo-900/10 rounded-lg border border-indigo-900/20">
                        ...
                        <TermsContent id="s5" title="5. Uso de la Plataforma y Evasión de Tarifas">
                            ...
                            <div className="mt-3 p-3 bg-red-900/10 rounded-lg border border-red-900/20">
