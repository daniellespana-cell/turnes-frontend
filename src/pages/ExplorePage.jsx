        ...
        <div className="min-h-screen bg-zinc-950 selection:bg-emerald-500/30 selection:text-emerald-200">
            ...
            <main className="pt-16 md:pt-24 pb-20 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="mt-20 p-8 md:p-12 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 text-center shadow-2xl skew-y-0 hover:border-white/20 transition-colors">
