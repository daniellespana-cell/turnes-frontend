            ...
            <div className="w-full max-w-[340px] relative z-10 flex flex-col gap-6 animate-fade-in-up p-4">
                ...
                <div className="text-center space-y-2">
                    <p className="text-[10px] text-zinc-500 leading-relaxed max-w-[280px] mx-auto">
                        ...
                        <a href="/terminos" className="text-zinc-400 hover:text-emerald-400 underline transition-colors">
                            Términos
                        </a>{' '}
                        y{' '}
                        <a href="/privacidad" className="text-zinc-400 hover:text-emerald-400 underline transition-colors">
