...
const ReputationBanner = () => {
  ...
  return (
    <motion.div 
      ...
      className="bg-gradient-to-b from-zinc-900 to-black border border-blue-500/20 p-8 rounded-[2.5rem] relative overflow-hidden group shadow-2xl shadow-blue-500/5"
    >
