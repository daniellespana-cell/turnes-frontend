...
const CandidatoCard = ({ can, onUpdate, onSellar }) => {
  ...
  // calificación para candidatos cuyo chat ya fue sellado (Step 4 completado).
  // Si llega un candidato sin sellar (por error del filtro padre), 
  // mostramos un estado seguro de solo lectura en vez de un formulario activo.
  const isReadyForRating = can.status === 'contratado' && can.isChatSealed;
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-6 relative z-10 flex flex-col h-full space-y-6">
        ...
        {/* --- 2. CALIFICACIÓN / 3. REPORTE / 4. ACCIÓN --- */}
        {isReadyForRating ? (
          <>
