                ...
                <>
                    ...
                    <div className="fixed inset-0 z-[99999] flex flex-col justify-end md:justify-center items-center pointer-events-none p-0 md:p-4">
                        ...
                        <motion.div
                            ...
                            className="w-full md:w-[420px] bg-[#121214] rounded-t-2xl md:rounded-2xl shadow-2xl flex flex-col max-h-[80vh] overflow-hidden pointer-events-auto border-t md:border border-white/10"
                        >
                            {/* HEADER COMPACT */}
                            ...
                            <div className="flex-1 overflow-y-auto px-5 py-2 pb-8 scrollbar-hide bg-[#121214]">
                                ...
                                <div className="flex flex-wrap gap-2 mt-3 mb-1">
                                    {['Urgente', 'Inmediato'].map((tag, i) => (
                                        <button key={i} className="px-2.5 py-1 rounded-md text-[10px] font-bold bg-zinc-800/40 border border-zinc-700 text-zinc-400 hover:border-zinc-500 hover:text-white transition-colors uppercase tracking-wide">
                                            {tag}
                                        </button>
                                    ))}
                                </div>
