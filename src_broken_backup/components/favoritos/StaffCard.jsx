    ...
    <div className="group bg-zinc-900/10 border border-transparent p-5 rounded-xl hover:bg-zinc-900/30 transition-all duration-500 relative">
      <div className="flex items-start justify-between mb-4">
        <img
          ...
          className="w-12 h-12 rounded-full border border-transparent bg-zinc-800"
          alt={staff.name}
        />
        <div className="flex items-center gap-1.5">
          {/* BADGE VERIFICACIÓN */}
          {staff.verified && (
            <div className="bg-blue-500/10 px-1.5 py-0.5 rounded border border-blue-500/20 flex items-center gap-1">
              <Zap size={8} className="text-blue-400 fill-blue-400" />
              <span className="text-[8px] font-black text-blue-400 uppercase tracking-tighter">Elite</span>
            </div>
          )}
          {/* BADGE CALLE */}
