        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="relative shrink-0">
              <img src={AssetResolver.getAvatar(cand.avatar_url || cand.avatar)} className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-transparent bg-zinc-800 group-hover:border-white/30 transition-colors" alt="" />
